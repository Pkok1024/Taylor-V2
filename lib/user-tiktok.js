...
export default async function getUserTikTokData(username) {
  ...
  try {
    const response = await axios.get(
      `https://tiktok-video-no-watermark2.p.rapidapi.com/user/posts?unique_id=@${username}&count=15`,
      {
        headers: {
          Accept: '*/*',
          'User-Agent':
            'TikTok 16.6.5 rv:166515 (iPhone; iOS 13.6; en_US) Cronet',
